...
`timescale 1ns/1ps
module real_matmul_dataflow_in_loop_CallBlockMatmul_1_MatB_BRAM_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 16,
    AddressRange = 150,
    AddressWidth = 8,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        real_matmul_dataflow_in_loop_CallBlockMatmul_1_MatB_BRAM_RAM_AUTO_1R1W_memcore real_matmul_dataflow_in_loop_CallBlockMatmul_1_MatB_BRAM_RAM_AUTO_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
            .address0 ( buf_a0[i] ),
            .d0       ( buf_d0[i] ),
