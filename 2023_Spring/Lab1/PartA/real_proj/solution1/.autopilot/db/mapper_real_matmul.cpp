...
using hls::sim::Byte;
extern "C" void real_matmul(Byte<2>*, int, int, int);
...
std::vector<Byte<2>> __xlx_MatA_DRAM_MatB_DRAM_MatC_DRAM__tmp_vec;
for (size_t i = 0; i < 15000; ++i){
__xlx_MatA_DRAM_MatB_DRAM_MatC_DRAM__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_MatA_DRAM)[i]);
}
  int __xlx_size_param_MatA_DRAM = 15000;
  int __xlx_offset_param_MatA_DRAM = 0;
  int __xlx_offset_byte_param_MatA_DRAM = 0*2;
for (size_t i = 0; i < 30000; ++i){
__xlx_MatA_DRAM_MatB_DRAM_MatC_DRAM__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_MatB_DRAM)[i]);
}
  int __xlx_size_param_MatB_DRAM = 30000;
  int __xlx_offset_param_MatB_DRAM = 15000;
  int __xlx_offset_byte_param_MatB_DRAM = 15000*2;
for (size_t i = 0; i < 20000; ++i){
__xlx_MatA_DRAM_MatB_DRAM_MatC_DRAM__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_MatC_DRAM)[i]);
}
  int __xlx_size_param_MatC_DRAM = 20000;
  int __xlx_offset_param_MatC_DRAM = 45000;
  int __xlx_offset_byte_param_MatC_DRAM = 45000*2;
  // DUT call
...
((Byte<2>*)__xlx_apatb_param_MatA_DRAM)[i] = __xlx_MatA_DRAM_MatB_DRAM_MatC_DRAM__tmp_vec[__xlx_offset_param_MatA_DRAM+i];
}
// print __xlx_apatb_param_MatB_DRAM
for (size_t i = 0; i < __xlx_size_param_MatB_DRAM; ++i) {
((Byte<2>*)__xlx_apatb_param_MatB_DRAM)[i] = __xlx_MatA_DRAM_MatB_DRAM_MatC_DRAM__tmp_vec[__xlx_offset_param_MatB_DRAM+i];
}
// print __xlx_apatb_param_MatC_DRAM
for (size_t i = 0; i < __xlx_size_param_MatC_DRAM; ++i) {
((Byte<2>*)__xlx_apatb_param_MatC_DRAM)[i] = __xlx_MatA_DRAM_MatB_DRAM_MatC_DRAM__tmp_vec[__xlx_offset_param_MatC_DRAM+i];
}
}
