set moduleName real_matmul_Pipeline_VITIS_LOOP_63_6
set isTopModule 0
...
set C_modelName {real_matmul_Pipeline_VITIS_LOOP_63_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ mem int 16 regular {axi_master 1}  }
	{ shl_ln int 7 regular  }
	{ MatC_DRAM int 64 regular  }
	{ sext_ln63 int 16 regular  }
	{ MatC_BRAM_1_0_2 int 16 regular  }
	{ MatC_BRAM_0_0_2 int 16 regular  }
	{ MatC_BRAM_1_1_2 int 16 regular  }
	{ MatC_BRAM_0_1_2 int 16 regular  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "MatA_DRAM","offset": { "type": "dynamic","port_name": "MatA_DRAM","bundle": "control"},"direction": "READONLY"},{"cName": "MatB_DRAM","offset": { "type": "dynamic","port_name": "MatB_DRAM","bundle": "control"},"direction": "READONLY"},{"cName": "MatC_DRAM","offset": { "type": "dynamic","port_name": "MatC_DRAM","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "MatC_BRAM_1_0_2", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "MatC_BRAM_0_0_2", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "MatC_BRAM_1_1_2", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "MatC_BRAM_0_1_2", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ m_axi_mem_WDATA sc_out sc_lv 16 signal 0 } 
	{ m_axi_mem_WSTRB sc_out sc_lv 2 signal 0 } 
	...
	{ m_axi_mem_RDATA sc_in sc_lv 16 signal 0 } 
	{ m_axi_mem_RLAST sc_in sc_logic 1 signal 0 } 
	{ m_axi_mem_RID sc_in sc_lv 1 signal 0 } 
	{ m_axi_mem_RFIFONUM sc_in sc_lv 10 signal 0 } 
	...
	{ shl_ln sc_in sc_lv 7 signal 1 } 
	{ MatC_DRAM sc_in sc_lv 64 signal 2 } 
	{ sext_ln63 sc_in sc_lv 16 signal 3 } 
	{ MatC_BRAM_1_0_2 sc_in sc_lv 16 signal 4 } 
	{ MatC_BRAM_0_0_2 sc_in sc_lv 16 signal 5 } 
	{ MatC_BRAM_1_1_2 sc_in sc_lv 16 signal 6 } 
	{ MatC_BRAM_0_1_2 sc_in sc_lv 16 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axi_mem_WDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "mem", "role": "WDATA" }} , 
 	{ "name": "m_axi_mem_WSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "mem", "role": "WSTRB" }} , 
 	...
 	{ "name": "m_axi_mem_RDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "mem", "role": "RDATA" }} , 
 	...
 	{ "name": "m_axi_mem_RFIFONUM", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "mem", "role": "RFIFONUM" }} , 
 	...
 	{ "name": "MatC_BRAM_1_0_2", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "MatC_BRAM_1_0_2", "role": "default" }} , 
 	{ "name": "MatC_BRAM_0_0_2", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "MatC_BRAM_0_0_2", "role": "default" }} , 
 	{ "name": "MatC_BRAM_1_1_2", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "MatC_BRAM_1_1_2", "role": "default" }} , 
 	{ "name": "MatC_BRAM_0_1_2", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "MatC_BRAM_0_1_2", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "real_matmul_Pipeline_VITIS_LOOP_63_6",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "MatC_BRAM_1_0_2", "Type" : "None", "Direction" : "I"},
			{"Name" : "MatC_BRAM_0_0_2", "Type" : "None", "Direction" : "I"},
			{"Name" : "MatC_BRAM_1_1_2", "Type" : "None", "Direction" : "I"},
			{"Name" : "MatC_BRAM_0_1_2", "Type" : "None", "Direction" : "I"}],
		"Loop" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_7ns_10ns_16_1_1_U18", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	real_matmul_Pipeline_VITIS_LOOP_63_6 {
		mem {Type O LastRead 5 FirstWrite 3}
		shl_ln {Type I LastRead 0 FirstWrite -1}
		MatC_DRAM {Type I LastRead 0 FirstWrite -1}
		sext_ln63 {Type I LastRead 0 FirstWrite -1}
		MatC_BRAM_1_0_2 {Type I LastRead 0 FirstWrite -1}
		MatC_BRAM_0_0_2 {Type I LastRead 0 FirstWrite -1}
		MatC_BRAM_1_1_2 {Type I LastRead 0 FirstWrite -1}
		MatC_BRAM_0_1_2 {Type I LastRead 0 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	 { m_axi {  { m_axi_mem_AWVALID VALID 1 1 }  { m_axi_mem_AWREADY READY 0 1 }  { m_axi_mem_AWADDR ADDR 1 64 }  { m_axi_mem_AWID ID 1 1 }  { m_axi_mem_AWLEN SIZE 1 32 }  { m_axi_mem_AWSIZE BURST 1 3 }  { m_axi_mem_AWBURST LOCK 1 2 }  { m_axi_mem_AWLOCK CACHE 1 2 }  { m_axi_mem_AWCACHE PROT 1 4 }  { m_axi_mem_AWPROT QOS 1 3 }  { m_axi_mem_AWQOS REGION 1 4 }  { m_axi_mem_AWREGION USER 1 4 }  { m_axi_mem_AWUSER DATA 1 1 }  { m_axi_mem_WVALID VALID 1 1 }  { m_axi_mem_WREADY READY 0 1 }  { m_axi_mem_WDATA FIFONUM 1 16 }  { m_axi_mem_WSTRB STRB 1 2 }  { m_axi_mem_WLAST LAST 1 1 }  { m_axi_mem_WID ID 1 1 }  { m_axi_mem_WUSER DATA 1 1 }  { m_axi_mem_ARVALID VALID 1 1 }  { m_axi_mem_ARREADY READY 0 1 }  { m_axi_mem_ARADDR ADDR 1 64 }  { m_axi_mem_ARID ID 1 1 }  { m_axi_mem_ARLEN SIZE 1 32 }  { m_axi_mem_ARSIZE BURST 1 3 }  { m_axi_mem_ARBURST LOCK 1 2 }  { m_axi_mem_ARLOCK CACHE 1 2 }  { m_axi_mem_ARCACHE PROT 1 4 }  { m_axi_mem_ARPROT QOS 1 3 }  { m_axi_mem_ARQOS REGION 1 4 }  { m_axi_mem_ARREGION USER 1 4 }  { m_axi_mem_ARUSER DATA 1 1 }  { m_axi_mem_RVALID VALID 0 1 }  { m_axi_mem_RREADY READY 1 1 }  { m_axi_mem_RDATA FIFONUM 0 16 }  { m_axi_mem_RLAST LAST 0 1 }  { m_axi_mem_RID ID 0 1 }  { m_axi_mem_RFIFONUM LEN 0 10 }  { m_axi_mem_RUSER DATA 0 1 }  { m_axi_mem_RRESP RESP 0 2 }  { m_axi_mem_BVALID VALID 0 1 }  { m_axi_mem_BREADY READY 1 1 }  { m_axi_mem_BRESP RESP 0 2 }  { m_axi_mem_BID ID 0 1 }  { m_axi_mem_BUSER DATA 0 1 } } }
	shl_ln { ap_none {  { shl_ln in_data 0 7 } } }
	MatC_DRAM { ap_none {  { MatC_DRAM in_data 0 64 } } }
	sext_ln63 { ap_none {  { sext_ln63 in_data 0 16 } } }
	MatC_BRAM_1_0_2 { ap_none {  { MatC_BRAM_1_0_2 in_data 0 16 } } }
	MatC_BRAM_0_0_2 { ap_none {  { MatC_BRAM_0_0_2 in_data 0 16 } } }
	MatC_BRAM_1_1_2 { ap_none {  { MatC_BRAM_1_1_2 in_data 0 16 } } }
	MatC_BRAM_0_1_2 { ap_none {  { MatC_BRAM_0_1_2 in_data 0 16 } } }
}
