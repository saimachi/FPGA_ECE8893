set moduleName real_matmul_Pipeline_VITIS_LOOP_45_1_VITIS_LOOP_46_2
set isTopModule 0
...
set C_modelName {real_matmul_Pipeline_VITIS_LOOP_45_1_VITIS_LOOP_46_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ mem int 16 regular {axi_master 0}  }
	{ rem_i_urem_cast int 7 regular  }
	{ MatA_BRAM int 16 regular {array 300 { 0 3 } 0 1 }  }
	{ MatB_BRAM int 16 regular {array 300 { 0 3 } 0 1 }  }
	{ sext_ln45 int 63 regular  }
	{ MatB_DRAM int 64 regular  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "MatA_DRAM","offset": { "type": "dynamic","port_name": "MatA_DRAM","bundle": "control"},"direction": "READONLY"},{"cName": "MatB_DRAM","offset": { "type": "dynamic","port_name": "MatB_DRAM","bundle": "control"},"direction": "READONLY"},{"cName": "MatC_DRAM","offset": { "type": "dynamic","port_name": "MatC_DRAM","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "rem_i_urem_cast", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
 	{ "Name" : "MatA_BRAM", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "MatB_BRAM", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sext_ln45", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ rem_i_urem_cast sc_in sc_lv 7 signal 1 } 
	{ MatA_BRAM_address0 sc_out sc_lv 9 signal 2 } 
	{ MatA_BRAM_ce0 sc_out sc_logic 1 signal 2 } 
	{ MatA_BRAM_we0 sc_out sc_logic 1 signal 2 } 
	{ MatA_BRAM_d0 sc_out sc_lv 16 signal 2 } 
	{ MatB_BRAM_address0 sc_out sc_lv 9 signal 3 } 
	{ MatB_BRAM_ce0 sc_out sc_logic 1 signal 3 } 
	{ MatB_BRAM_we0 sc_out sc_logic 1 signal 3 } 
	{ MatB_BRAM_d0 sc_out sc_lv 16 signal 3 } 
	{ sext_ln45 sc_in sc_lv 63 signal 4 } 
	{ MatB_DRAM sc_in sc_lv 64 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rem_i_urem_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "rem_i_urem_cast", "role": "default" }} , 
 	...
 	{ "name": "MatA_BRAM_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "MatA_BRAM", "role": "we0" }} , 
 	{ "name": "MatA_BRAM_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "MatA_BRAM", "role": "d0" }} , 
 	...
 	{ "name": "MatB_BRAM_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "MatB_BRAM", "role": "we0" }} , 
 	{ "name": "MatB_BRAM_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "MatB_BRAM", "role": "d0" }} , 
 	{ "name": "sext_ln45", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln45", "role": "default" }} , 
 	{ "name": "MatB_DRAM", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "MatB_DRAM", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		"CDFG" : "real_matmul_Pipeline_VITIS_LOOP_45_1_VITIS_LOOP_46_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "rem_i_urem_cast", "Type" : "None", "Direction" : "I"},
			{"Name" : "MatA_BRAM", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "MatB_BRAM", "Type" : "Memory", "Direction" : "O"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_2ns_9ns_10_1_1_U1", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	real_matmul_Pipeline_VITIS_LOOP_45_1_VITIS_LOOP_46_2 {
		...
		rem_i_urem_cast {Type I LastRead 0 FirstWrite -1}
		MatA_BRAM {Type O LastRead -1 FirstWrite 11}
		MatB_BRAM {Type O LastRead -1 FirstWrite 12}
...
set Spec2ImplPortList { 
	...
	rem_i_urem_cast { ap_none {  { rem_i_urem_cast in_data 0 7 } } }
	MatA_BRAM { ap_memory {  { MatA_BRAM_address0 mem_address 1 9 }  { MatA_BRAM_ce0 mem_ce 1 1 }  { MatA_BRAM_we0 mem_we 1 1 }  { MatA_BRAM_d0 mem_din 1 16 } } }
	MatB_BRAM { ap_memory {  { MatB_BRAM_address0 mem_address 1 9 }  { MatB_BRAM_ce0 mem_ce 1 1 }  { MatB_BRAM_we0 mem_we 1 1 }  { MatB_BRAM_d0 mem_din 1 16 } } }
	sext_ln45 { ap_none {  { sext_ln45 in_data 0 63 } } }
